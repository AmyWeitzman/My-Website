  ...
  return (
    <div className="content">
        ...
        <div className="container">
            ...
            <div className="img">
                <img src={require("../images/BANs1.jpg")} alt="Body Area Networks"/> 
            </div>
            ...
            <div className="img">
                <img src={require("../images/BANs3.PNG")} alt="Applications of Body Area Networks" width="500px"/>
            ...
            <div className="img">
                <img src={require("../images/BANs2.PNG")} alt="Components of Body Area Networks" width="350px"/>
            ...
            <div className="img">
                <img src={require("../images/BANs4.PNG")} alt="BodyMAC Frame Structure" width="500px"/>
            ...
            <div className="img">
                <img src={require("../images/BANs8.png")} alt="Sleep Mode" width="250px"/>
            ...
            <div className="img">
                <img src={require("../images/BANs5.PNG")} alt="Concept of a Body Area Network" width="550px"/>
            ...
            <div className="img">
                <img src={require("../images/BANs6.PNG")} alt="BANs Connect to Healthcare Providers" width="550px"/>
            ...
            <div className="img">
                <img src={require("../images/BANs7.jpg")} alt="BANs Provide Privacy and Security" width="550px"/>
